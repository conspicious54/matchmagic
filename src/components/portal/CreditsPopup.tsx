...
export function CreditsPopup({ isOpen, onClose }: CreditsPopupProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 md:p-8">
      <div className="relative w-full max-w-2xl bg-gray-900 rounded-2xl shadow-2xl max-h-[90vh] overflow-hidden">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="overflow-y-auto max-h-[90vh] p-4 md:p-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 bg-gradient-to-r from-white to-pink-500 bg-clip-text text-transparent pr-8">
            Add Credits
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-8">
            ...
            >
              ...
              <div className="relative">
                <div className="flex items-center justify-between mb-3 md:mb-4">
                  <Infinity className="w-5 h-5 md:w-6 md:h-6 text-pink-500" />
                  <div className="px-2 py-1 md:px-3 md:py-1 bg-pink-500/20 rounded-full">
                ...
                <p className="text-sm md:text-base text-gray-300 mb-3 md:mb-4">Generate unlimited photos every month</p>
            ...
            >
              ...
              <p className="text-sm md:text-base text-gray-300 mb-3 md:mb-4">100 credits for one-time purchase</p>
